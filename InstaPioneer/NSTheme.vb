...
Class NSProgressBar
    ...
    Sub New()
        ...
        B1 = New SolidBrush(Color.FromArgb(40, 176, 95))
    End Sub
    ...
    Protected Overrides Sub OnPaint(e As System.Windows.Forms.PaintEventArgs)
        ...
        If I1 > 1 Then
            ...
            GB2 = New LinearGradientBrush(R2, Color.FromArgb(40, 176, 95), Color.FromArgb(30, 130, 70), 90.0F)
...
Class NSTabControl
    ...
    Sub New()
        ...
        B3 = New SolidBrush(Color.FromArgb(40, 176, 95))
...
Class NSOnOffBox
    ...
    Sub New()
        ...
        B4 = New SolidBrush(Color.FromArgb(40, 176, 95))
    ...
    Protected Overrides Sub OnPaint(e As System.Windows.Forms.PaintEventArgs)
        ...
        If _Checked Then
            G.DrawString("Yes", Font, Brushes.Black, R2, SF1)
            G.DrawString("Yes", Font, Brushes.White, R1, SF1)

            R3.X += (Width \ 2) - 1
        Else
            G.DrawString("No", Font, B1, R2, SF2)
            G.DrawString("No", Font, B2, R1, SF2)
        End If
...
Class NSTrackBar
    ...
    Sub New()
        ...
        P1 = New Pen(Color.FromArgb(40, 176, 95), 2)
        P2 = New Pen(Color.FromArgb(55, 55, 55))
    ...
    Protected Overrides Sub OnPaint(e As System.Windows.Forms.PaintEventArgs)
        ...
        GB2 = New LinearGradientBrush(R3, Color.FromArgb(40, 176, 95), Color.FromArgb(30, 130, 70), 90.0F)
